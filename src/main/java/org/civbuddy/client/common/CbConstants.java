...
import org.civbuddy.client.resources.CbLocalizedConstantsIF;
import org.civbuddy.client.resources.CbLocalizedMessagesIF;
import org.civbuddy.client.resources.CbVersionIF;
...
public final class CbConstants
{
    ...
    /** CSS selector prefix for {@link org.civbuddy.client.widgets.CbIconButton} styles */
    public static final String CSS_ICONBUTTON = "cb-iconbutton-"; //$NON-NLS-1$

    /** CSS selector prefix for {@link org.civbuddy.client.widgets.CbBarButton} styles */
    public static final String CSS_BARBUTTON = "cb-barbutton-"; //$NON-NLS-1$

    /** CSS selector prefix for {@link org.civbuddy.client.widgets.CbNavigationButton} styles */
