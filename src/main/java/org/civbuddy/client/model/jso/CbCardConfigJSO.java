    ...
    extends JavaScriptObject
{
    ...
    /*-{
        this[@org.civbuddy.client.model.jso.CbCardConfigJSO::PROP_MININGBONUS] = pGranted;
    }-*/;
    ...
    /*-{
        if (this.hasOwnProperty(@org.civbuddy.client.model.jso.CbCardConfigJSO::PROP_MININGBONUS)) {
            return this[@org.civbuddy.client.model.jso.CbCardConfigJSO::PROP_MININGBONUS];
        } else {
            return false;
        }
    }-*/;
