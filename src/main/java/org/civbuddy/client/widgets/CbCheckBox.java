...
import org.civbuddy.client.event.CbAnimationEndHandlerIF;
    ...
    implements HasEnabled, HasValue<Boolean>
{
    ...
    /*-{
        var callback = function() {
            pHandler.@org.civbuddy.client.event.CbAnimationEndHandlerIF::onAnimationEnd()();
        }
        if (!@org.civbuddy.client.common.CbUtil::isMSIE()) {
