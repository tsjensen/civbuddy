 ...
 * directly deduced from those are place in {@link CcCardConfig}, because JSOs
 * cannot have Java instance fields. Both classes do not cover dynamic information
 * based on haves and plans, which is found in {@link CcCardCurrent}.
 *
 * @author Thomas Jensen
 */
public final class CcCardConfigJSO
    extends JavaScriptObject
{
    /**
     * JSO constructor.
     */
    protected CcCardConfigJSO()
    {
        super();
    }
    ...
    static CcCardConfigJSO create()
    {
        ...
        result.setPrereq(-1);
        result.setAttributes(CcStringsI18nJSO.create());
        result.setClamityEffects(CcStringsI18nJSO.create());
        return result;
    }
    ...
    public CcGroup[] getGroups()
    {
        ...
        if (arr != null && arr.length() > 0) {
            result = new CcGroup[arr.length()];
            for (int i = 0; i < arr.length(); i++) {
                result[i] = CcGroup.fromKey(arr.get(i).charAt(0));
            }
        }
        return result;
    }
     ...
     */
    public native CcStringsI18nJSO getAttributes()
    /*-{
     ...
     */
    private native void setAttributes(final CcStringsI18nJSO pAttributes)
    /*-{
     ...
     */
    public native CcStringsI18nJSO getClamityEffects()
    /*-{
     ...
     */
    private native void setClamityEffects(final CcStringsI18nJSO pCalamityEffects)
    /*-{
