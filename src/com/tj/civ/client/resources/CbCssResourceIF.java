...
/**
 * Generated CSS resource file. For comments refer to the original CSS file.
 *
    ...
    extends CssResource
{
    ...
    @ClassName("cc-StatsIndicator")
    String ccStatsIndicator();

    @ClassName("cc-StatsIndicatorDisabled")
    String ccStatsIndicatorDisabled();

    @ClassName("cc-StatsPlanned")
    String ccStatsPlanned();
    ...
    @ClassName("cc-detail-CardTitle")
    String ccDetailCardTitle();
